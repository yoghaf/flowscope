...
class Settings(BaseSettings):
    ...
    entry_filter_min_clarity_confidence: float = 0.55
    entry_filter_min_volume_z: float = 1.00
    entry_filter_min_abs_oi_delta_z: float = 0.80
    entry_filter_max_oi_percentile: float = 0.95
    entry_filter_min_history_1h: int = 24
    entry_filter_max_volume_z_15m: float = 8.00
    entry_filter_max_oi_delta_z_15m: float = 4.00
    entry_filter_min_atr_24h: float = 0.03
    entry_filter_min_atr_1h: float = 0.005
    entry_filter_min_atr_15m: float = 0.005
    entry_filter_max_compression_score_15m: float = 0.60
    entry_filter_min_wick_ratio_24h: float = 0.02
    entry_filter_min_volume_change_4h: float = -0.80
