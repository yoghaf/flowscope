...
# V14 epoch: only show trades created after V14 engine deployment.
# All trades before this timestamp were generated by inferior filter versions.
V14_EPOCH = datetime(2026, 4, 2, 5, 0, 0, tzinfo=UTC)
...
async def get_live_signals(
    ...
    # Only show V14-era trades
    trades = [t for t in trades if t.created_at and t.created_at >= V14_EPOCH]
