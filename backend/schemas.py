...
class FlowMetrics(BaseModel):
    ...
    btc_return_24h: float | None = None
    eth_return_15m: float | None = None
    eth_return_1h: float | None = None
    eth_return_4h: float | None = None
    eth_return_24h: float | None = None
    top120_median_return_15m: float | None = None
    top120_median_return_1h: float | None = None
    top120_median_return_4h: float | None = None
    top120_median_return_24h: float | None = None
    top120_breadth_positive_15m: float | None = None
    top120_breadth_positive_1h: float | None = None
    top120_breadth_positive_4h: float | None = None
    top120_breadth_positive_24h: float | None = None
    top120_breadth_negative_15m: float | None = None
    top120_breadth_negative_1h: float | None = None
    top120_breadth_negative_4h: float | None = None
    top120_breadth_negative_24h: float | None = None
    top120_breadth_net_15m: float | None = None
    top120_breadth_net_1h: float | None = None
    top120_breadth_net_4h: float | None = None
    top120_breadth_net_24h: float | None = None
    market_return_sample_size_15m: int = 0
    market_return_sample_size_1h: int = 0
    market_return_sample_size_4h: int = 0
    market_return_sample_size_24h: int = 0
    token_vs_btc_return_15m: float | None = None
    token_vs_btc_return_1h: float | None = None
    token_vs_btc_return_4h: float | None = None
    token_vs_btc_return_24h: float | None = None
    token_vs_eth_return_15m: float | None = None
    token_vs_eth_return_1h: float | None = None
    token_vs_eth_return_4h: float | None = None
    token_vs_eth_return_24h: float | None = None
    token_vs_market_return_15m: float | None = None
    token_vs_market_return_1h: float | None = None
    token_vs_market_return_4h: float | None = None
    token_vs_market_return_24h: float | None = None
    return_percentile_15m: float | None = None
    return_percentile_1h: float | None = None
    return_percentile_4h: float | None = None
    return_percentile_24h: float | None = None
    return_rank_15m: int | None = None
    return_rank_1h: int | None = None
    return_rank_4h: int | None = None
    return_rank_24h: int | None = None
    market_relative_status_15m: str = "UNKNOWN_MARKET_CONTEXT"
    market_relative_status_1h: str = "UNKNOWN_MARKET_CONTEXT"
    market_relative_status_4h: str = "UNKNOWN_MARKET_CONTEXT"
    market_relative_reason_15m: str = "missing_market_relative_context"
    market_relative_reason_1h: str = "missing_market_relative_context"
    market_relative_reason_4h: str = "missing_market_relative_context"
    relative_strength_score_15m: float = 0.0
    relative_strength_score_1h: float = 0.0
    relative_strength_score_4h: float = 0.0
    relative_weakness_score_15m: float = 0.0
    relative_weakness_score_1h: float = 0.0
    relative_weakness_score_4h: float = 0.0
    market_independence_score_15m: float = 0.0
    market_independence_score_1h: float = 0.0
    market_independence_score_4h: float = 0.0
    ...
    # Phase 8A: Entry Location / Phase Primitives (observability-only)
    range_position_15m: float | None = None
    range_position_1h: float | None = None
    range_position_4h: float | None = None
    distance_from_range_high_pct_15m: float | None = None
    distance_from_range_high_pct_1h: float | None = None
    distance_from_range_high_pct_4h: float | None = None
    distance_from_range_low_pct_15m: float | None = None
    distance_from_range_low_pct_1h: float | None = None
    distance_from_range_low_pct_4h: float | None = None
    distance_from_range_mid_pct_15m: float | None = None
    distance_from_range_mid_pct_1h: float | None = None
    distance_from_range_mid_pct_4h: float | None = None
    atr_extension_15m: float | None = None
    atr_extension_1h: float | None = None
    atr_extension_4h: float | None = None
    recent_move_atr_15m: float | None = None
    recent_move_atr_1h: float | None = None
    recent_move_atr_4h: float | None = None
    candle_body_atr_15m: float | None = None
    candle_body_atr_1h: float | None = None
    candle_body_atr_4h: float | None = None
    breakout_age_candles_15m: int | None = None
    breakout_age_candles_1h: int | None = None
    breakout_age_candles_4h: int | None = None
    breakdown_age_candles_15m: int | None = None
    breakdown_age_candles_1h: int | None = None
    breakdown_age_candles_4h: int | None = None
    consecutive_green_candles_15m: int = 0
    consecutive_green_candles_1h: int = 0
    consecutive_green_candles_4h: int = 0
    consecutive_red_candles_15m: int = 0
    consecutive_red_candles_1h: int = 0
    consecutive_red_candles_4h: int = 0
    volume_climax_score_15m: float | None = None
    volume_climax_score_1h: float | None = None
    volume_climax_score_4h: float | None = None
    oi_climax_score_15m: float | None = None
    oi_climax_score_1h: float | None = None
    oi_climax_score_4h: float | None = None
    wick_rejection_score_15m: float | None = None
    wick_rejection_score_1h: float | None = None
    wick_rejection_score_4h: float | None = None
    is_near_range_high_15m: bool = False
    is_near_range_high_1h: bool = False
    is_near_range_high_4h: bool = False
    is_near_range_low_15m: bool = False
    is_near_range_low_1h: bool = False
    is_near_range_low_4h: bool = False
    is_extended_from_range_mid_15m: bool = False
    is_extended_from_range_mid_1h: bool = False
    is_extended_from_range_mid_4h: bool = False
    is_late_breakout_15m: bool = False
    is_late_breakout_1h: bool = False
    is_late_breakout_4h: bool = False
    is_late_breakdown_15m: bool = False
    is_late_breakdown_1h: bool = False
    is_late_breakdown_4h: bool = False
    entry_location_phase_15m: str = "UNKNOWN_LOCATION"
    entry_location_phase_1h: str = "UNKNOWN_LOCATION"
    entry_location_phase_4h: str = "UNKNOWN_LOCATION"
    entry_location_quality_15m: str = "UNKNOWN"
    entry_location_quality_1h: str = "UNKNOWN"
    entry_location_quality_4h: str = "UNKNOWN"
    entry_location_reason_15m: str = "unknown_location_not_classified"
    entry_location_reason_1h: str = "unknown_location_not_classified"
    entry_location_reason_4h: str = "unknown_location_not_classified"
    opposite_signal_watch_15m: str = "NONE"
    opposite_signal_watch_1h: str = "NONE"
    opposite_signal_watch_4h: str = "NONE"
